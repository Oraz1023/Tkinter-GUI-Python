...
#
# Button(root, text="Button 1", padx=50,pady=5).pack(pady=10)
# ttk.Button(root, text="Button 2", width=18,style="red.TButton").pack()
# ttk.Button(root, text="Button 3", width=18).pack(pady=10)
#
